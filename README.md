...
> **Rebuild in progress:** Commerce.js (Chec) has been discontinued, so the live demo can no longer load products or check out. The app is being rebuilt with Next.js, Postgres and Stripe.
